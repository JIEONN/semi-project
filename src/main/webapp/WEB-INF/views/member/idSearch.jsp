...
<body>
	...
	<div class="test">
	<form action="/idSearch.do" method="post" onsubmit="return check()">
		<!-- <div class="idsearch-content"> -->
			<div class="input-wrap">
				<label for="memberName"><h3>이름</h3></label> <input type="text" name="memberName" id="memberName" class="input-form">
			</div>
			<div class="input-wrap">
			...
			<div class="input-wrap">
				<div id="auth" style="display:none">
					<label for="checkNum"><h3>인증번호</h3></label><span id="timeZone"></span> | <span id="authMsg"></span> <input  type="text" id="authCode" placeholder="인증코드입력" class="input-form"> 
