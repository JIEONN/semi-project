 ...
 */
@WebServlet(name = "UpdateReview", urlPatterns = { "/updateReview.do" })
public class UpdateReviewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String filename = mRequest.getOriginalFileName("newfile");
		String filepath = mRequest.getFilesystemName("newfile");
		int reviewNo = Integer.parseInt(mRequest.getParameter("reviewNo"));
		String productId = mRequest.getParameter("productId");
		String reviewContent = mRequest.getParameter("newContent");

		Review r = new Review(reviewNo, productId, productId, reviewContent, filename, filepath, null, 0);
		// 3.비지니스로직
