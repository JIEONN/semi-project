 ...
 */
@WebServlet(name = "AdminMypage", urlPatterns = { "/adminMypage.do" })
...
request.setCharacterEncoding("utf-8");
		...
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/member/adminMypage/adminMypage.jsp");
