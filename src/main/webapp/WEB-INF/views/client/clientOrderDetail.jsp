...
<body>
	...
	<div class="wrap">
		...
		<div class="page-content">
			...
			<tr>
				<td width=200px><img src="/upload/product/<%=order.getProductFilepath()%>" id="img" width="150px"></td>
	...
	<div class="submitBtn">
		<a id="close" href="index.jsp">계속쇼핑하기</a><a id="close" href="/clientPayment.do?memberId=<%=m.getMemberId()%>&reqPage=1">주문조회</a>
	</div>
