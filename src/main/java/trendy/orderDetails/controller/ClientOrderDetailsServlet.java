...
/**
 * Servlet implementation class ClientOrderDetailsServlet
 */
@WebServlet(name = "ClientOrderDetails", urlPatterns = { "/clientOrderDetails.do" })
public class ClientOrderDetailsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ClientOrderDetailsServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/client/clientOrderDetail.jsp");
